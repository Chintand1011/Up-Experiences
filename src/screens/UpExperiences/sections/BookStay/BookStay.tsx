  ...
  return (
    <>
      <div className="flex flex-col items-center gap-4 md:gap-10 px-4 md:px-[60px] py-6 md:py-[60px] w-full translate-y-0 md:translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:2200ms]">
        <div className="flex flex-col lg:flex-row w-full max-w-[1320px] items-center justify-between md:px-[60px] py-4 md:py-[52px] rounded-[20px] bg-[linear-gradient(315deg,rgba(124,13,72,1)_0%,rgba(75,8,43,1)_49%,rgba(75,8,43,1)_67%,rgba(124,13,72,1)_100%)] relative gap-4 md:gap-6 lg:gap-0">
